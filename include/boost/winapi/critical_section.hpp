...
namespace winapi {
namespace detail {
    typedef CRITICAL_SECTION BOOST_WINAPI_RTL_CRITICAL_SECTION;
}
}
}
#else
...
namespace winapi {
namespace detail {
typedef _RTL_CRITICAL_SECTION BOOST_WINAPI_RTL_CRITICAL_SECTION;
}
}
}
#endif
...
InitializeCriticalSection(::boost::winapi::detail::_RTL_CRITICAL_SECTION* lpCriticalSection);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
EnterCriticalSection(::boost::winapi::detail::_RTL_CRITICAL_SECTION* lpCriticalSection);

BOOST_WINAPI_IMPORT_EXCEPT_WM boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
LeaveCriticalSection(::boost::winapi::detail::_RTL_CRITICAL_SECTION* lpCriticalSection);

#if BOOST_USE_WINAPI_VERSION >= 0x0403
#if BOOST_WINAPI_PARTITION_APP_SYSTEM
BOOST_WINAPI_IMPORT boost::winapi::BOOL_ BOOST_WINAPI_WINAPI_CC
InitializeCriticalSectionAndSpinCount(
    ::boost::winapi::detail::_RTL_CRITICAL_SECTION* lpCriticalSection,
...
TryEnterCriticalSection(::boost::winapi::detail::_RTL_CRITICAL_SECTION* lpCriticalSection);
#endif

BOOST_WINAPI_IMPORT_EXCEPT_WM boost::winapi::VOID_ BOOST_WINAPI_WINAPI_CC
DeleteCriticalSection(::boost::winapi::detail::_RTL_CRITICAL_SECTION* lpCriticalSection);
