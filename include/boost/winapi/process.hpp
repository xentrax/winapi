...
// Unified function that to exit process on Windows CE and normal Windows
inline BOOST_NORETURN boost::winapi::VOID_ exit_process(boost::winapi::UINT_ uExitCode);
{
    // On Windows CE ExitProcess is a macro to call TerminateProcess
